          ...
          <Accordion.Item eventKey="8" className={classes.accordionItem}>
            ...
            <Accordion.Body>
              <p>
                ...
                cc0 and open-source. Every 19th SZNoun for the first 5 years of the project (SZNoun
                ids #19, #38, #57, #76, and so on) will be automatically sent to the Nouns DAO to be
                vested and shared among members of the project. This is equivalent to approximately
                5% of total supply in the first five years.
              </p>
              <p>
