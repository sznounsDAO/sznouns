...
export class NounsAuctionHouseProxy extends ethereum.SmartContract {
  static bind(address: Address): NounsAuctionHouseProxy {
    return new NounsAuctionHouseProxy("NounsAuctionHouseProxy", address);
  }
